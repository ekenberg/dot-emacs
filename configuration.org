...
** DONE Can Emacs regularly remind me to update packages?
...
#+RESULTS:
: my-open-current-file-in-external-program
...
*** Directories
#+BEGIN_SRC emacs-lisp
  (defun my-org-directories ()
    (setq org-directory "~/Dropbox/org")
    (setq org-default-notes-file (concat org-directory "/Capture.org"))
    )

  (add-hook 'org-mode-hook 'my-org-directories)
#+END_SRC
