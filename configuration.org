...
#+BEGIN_SRC emacs-lisp
  (use-package smart-tab
    ...
    ;; for some reason, smart-tab makes RETURN enter double newlines in src code blocks in org-mode
    ;; turning off electic-indent-mode locally in org-files reasonably solves the problem
