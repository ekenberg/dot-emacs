...
#+BEGIN_SRC emacs-lisp
      (use-package counsel
        ...
        :bind (("C-s" . swiper) ;; replace default search
               ...
               ;; ("K" . ivy-occur-keep-lines) ;; FIX THIS IT DOESN'T GET BOUND
      ...
      ;;           (lambda ()
  ;;              (define-key ivy-occur-mode-map (kbd "K") 'ivy-occur-keep-lines)))
...
;;  (ivy-define-key ivy-occur-mode-map (kbd "K") 'ivy-occur-keep-lines)
