...
#+BEGIN_SRC emacs-lisp
  (defun my/comment-region-or-line ()
    "Comment the current region. Without an active region, comment the current line"
    (interactive)
  ...
  (defun my/uncomment-region-or-line ()
    "Uncomment the current region. Without an active region, uncomment the current line"
    (interactive)
    (save-window-excursion
      (save-excursion
        (let ((start (if (use-region-p) (region-beginning) (line-beginning-position)))
