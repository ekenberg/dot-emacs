...
Argument passed (C-u) and no region selected: shell-command arg, output at point. \
Region selected: shell-command-on-region, output to mini-buffer. \
Argument passed (C-u) and region selected: shell-command-on-region, output at point."
  (interactive "P")
